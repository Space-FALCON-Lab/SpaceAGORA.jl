...
outdir = joinpath(DEMO_OUT_ROOT, "earth_4day")
args = SimulationConfiguration(
    ...
    mission_configuration=MissionConfiguration(mission_type=MissionTime, keplerian=true, number_of_orbits=1,
        mission_time=4.0 * 86400.0, orientation_sim=false, num_steps_to_save=1000),
...
html = export_visualization(joinpath(outdir, "simulation_results"); max_frames=4000, trail_orbits=3, title="AGORA Earth · 4 days")
