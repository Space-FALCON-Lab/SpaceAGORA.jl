...
function aerobraking_campaign(args, state,sim_id)
    ...
    try
        ...
        println("Error during setup of aerobraking campaign: ", e)
        println("Stack trace:")
    end
    ...
    try
        ...
        println("Error during aerobraking setup 2: ", e)
        println("Stack trace:")
    end
    ...
    config.check_threads(args[:barrier]) # Check if all threads have finished
