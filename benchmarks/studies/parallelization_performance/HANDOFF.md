...
- `test/gates/ci_path_policy_gate.jl` (formerly `ci_benchmark_wrapper_parity_gate`)
...
- `julia --project=. --startup-file=no test/gates/ci_path_policy_gate.jl`
- `julia --project=. --startup-file=no test/gates/ci_thin_entry_files_gate.jl`
...
- `julia --project=. --startup-file=no test/gates/ci_architecture_contract_gate.jl`
