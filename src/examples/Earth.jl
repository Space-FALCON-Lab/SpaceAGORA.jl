...
args = Dict(# Misc Simulation
            ...
            :a_initial_a => 31452.5e3,                         # Initial semi-mjaor axis (km) for for-loop if initial conditions are in keplerian elements
            ...
            :e_initial_a => 0.792258167,                                  # Initial eccentricity for for-loop if initial conditions are in keplerian elements
            :e_initial_b => 0.8,                                  # Final eccentricity for for-loop if initial conditions are in keplerian elements
