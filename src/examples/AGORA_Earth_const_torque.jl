...
table = Arrow.Table("basilisk_gg_quat_pos.feather")
...
args = Dict(# Misc Simulation
            ...
            :directory_results => "/workspaces/SpaceAGORA.jl/output/basilisk_const_torque_comparison",                # Directory where to save the results
