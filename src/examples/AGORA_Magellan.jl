...
args = Dict(# Misc Simulation
            ...
            :directory_results => "/home/space-falcon-1/Documents/SpaceAGORA.jl/output/magellan",            # Directory where to save the results
            :directory_Gram => "/home/space-falcon-1/Documents/SpaceAGORA.jl/GRAMpy",                   # Directory where Gram is
            :directory_Gram_data => "/home/space-falcon-1/Documents/SpaceAGORA.jl/GRAM_Data",           # Directory where Gram data is
            :directory_Spice => "/home/space-falcon-1/Documents/SpaceAGORA.jl/GRAM_Data/SPICE",         # Directory where SPICE files are located
            ...
            :normalize => 0,                                       # Normalize the results True=1, False=0
