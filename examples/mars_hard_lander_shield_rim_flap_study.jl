...
const SHIELD_RIM_FLAP_OUTPUT_ROOT = "/Users/josephine/Research/Space-FALCON/_Proposals/[FY27]SURP/SHIELD_RimFlap_Study"

geom = MarsHardLanderPrelim.shield_published_surrogate_geometry()

cfg = MarsHardLanderPrelim.default_config(
    output_root=SHIELD_RIM_FLAP_OUTPUT_ROOT,
...
MarsHardLanderPrelim.run_shield_rim_flap_study(
    cfg,
    adapter;
    entry_mass_kg=120.0,
    flap_area_fractions_of_skirt=[0.01, 0.02, 0.05],
