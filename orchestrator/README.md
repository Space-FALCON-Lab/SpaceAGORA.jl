...
- `ORCH_SPICE_PATH`: SPICE kernel root (default: `<repo>/data/GRAMSuite.jl/GRAM Suite 2.0/SPICE`, fallback `<repo>/GRAM_Data/SPICE`)
- `ORCH_GRAM_DATA_PATH`: GRAM data root (default: `<repo>/data/GRAMSuite.jl/GRAM Suite 2.0`, fallback `<repo>/GRAM_Data`)
