...
function propulsion_ic_calcs(m, args, initial_state)
    ...
    if length(config.solution.performance.mass) == 0
        ...
        results[85] = (config.solution.forces.τ_bb[1][index_a] + (config.solution.forces.τ_bb[1][index_b] - config.solution.forces.τ_bb[1][index_a]) / (dist_b + abs(dist_a)) * abs(dist_a))
        results[86] = (config.solution.forces.τ_bb[2][index_a] + (config.solution.forces.τ_bb[2][index_b] - config.solution.forces.τ_bb[2][index_a]) / (dist_b + abs(dist_a)) * abs(dist_a))
        results[87] = (config.solution.forces.τ_bb[3][index_a] + (config.solution.forces.τ_bb[3][index_b] - config.solution.forces.τ_bb[3][index_a]) / (dist_b + abs(dist_a)) * abs(dist_a))
