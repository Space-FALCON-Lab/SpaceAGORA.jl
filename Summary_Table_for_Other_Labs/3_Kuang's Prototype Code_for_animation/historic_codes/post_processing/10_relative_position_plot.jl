...
abs_path = joinpath(output_dir, "absolute_position_xyz_timeseries.png")
abs_path_pdf = joinpath(output_dir, "absolute_position_xyz_timeseries.pdf")
...
p_rx = plot(t_hours, rel_x ./ 1000, label="ΔX (Helper − Target)", color=:red, lw=2,
            xlabel="Time, hours", ylabel="ΔX, km",
            xguidefontsize=xlabel_fontsize, yguidefontsize=ylabel_fontsize,
            grid=true, legend=:best)

# ── Relative Position Y over time (helper relative to target) ─────────────────
p_ry = plot(t_hours, rel_y ./ 1000, label="ΔY (Helper − Target)", color=:green, lw=2,
            xlabel="Time, hours", ylabel="ΔY, km",
            xguidefontsize=xlabel_fontsize, yguidefontsize=ylabel_fontsize,
            grid=true, legend=:best)

# ── Relative Position Z over time (helper relative to target) ─────────────────
p_rz = plot(t_hours, rel_z ./ 1000, label="ΔZ (Helper − Target)", color=:blue, lw=2,
            xlabel="Time, hours", ylabel="ΔZ, km",
            xguidefontsize=xlabel_fontsize, yguidefontsize=ylabel_fontsize,
            grid=true, legend=:best)
...
rel_xyz_path = joinpath(output_dir, "relative_position_xyz_timeseries.png")
rel_xyz_path_pdf = joinpath(output_dir, "relative_position_xyz_timeseries.pdf")
...
pc_3d = plot3d(rel_x ./ 1000, rel_y ./ 1000, rel_z ./ 1000,
               label="Helper trajectory", color=:viridis, lw=2,
               xlabel="ΔX, km", ylabel="ΔY, km", zlabel="ΔZ, km",
...
pc_rx = plot(t_hours, rel_x ./ 1000, label="ΔX (Helper − Target)", color=:red, lw=2,
             xlabel="Time, hours", ylabel="ΔX, km",
...
pc_ry = plot(t_hours, rel_y ./ 1000, label="ΔY (Helper − Target)", color=:green, lw=2,
             xlabel="Time, hours", ylabel="ΔY, km",
             xguidefontsize=combined_ts_xlabel_fontsize,
             yguidefontsize=combined_ts_ylabel_fontsize,
             xtickfontsize=combined_ts_tick_fontsize,
...
pc_rz = plot(t_hours, rel_z ./ 1000, label="ΔZ (Helper − Target)", color=:blue, lw=2,
             xlabel="Time, hours", ylabel="ΔZ, km",
             xguidefontsize=combined_ts_xlabel_fontsize,
             yguidefontsize=combined_ts_ylabel_fontsize,
             xtickfontsize=combined_ts_tick_fontsize,
...
combined_path     = joinpath(output_dir, "combined_3d_and_relative_xyz.png")
combined_path_pdf = joinpath(output_dir, "combined_3d_and_relative_xyz.pdf")
