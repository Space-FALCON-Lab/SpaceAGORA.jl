...
function planet_data(ip)
    ...
    elseif (ip == 1 || (typeof(ip) == String && cmp(lowercase(ip), "mars") == 0)) # Mars
        ...
        # 50 km to 300 km
        polyfit_coeffs = [-2.29452937975697253e+01,
                            -1.13982645717919997e+01,
                            2.56415006552992475e+00,
                            -5.11185837237099344e-02,
                            -2.87521974560208671e-01,
                            1.62661133476727587e-01,
                            -9.93236885240249834e-02,
                            5.93932367358700267e-02,
                            -3.33102553294900572e-03,
                            1.15314648525143134e-04,
                            1.32372131183792121e-02,
                            -2.08858021016496351e-02,
                            3.93582636392388954e-02]
    ...
    elseif (ip == 2 || (typeof(ip) == String && cmp(lowercase(ip), "venus") == 0)) # Venus
        ...
        # 50 km to 250 km
        polyfit_coeffs = [-1.76144688197202761e+01,
                            -1.64726201892588335e+01,
                            3.40142658311144253e+00,
                            8.97507849982874029e-01,
                            -1.06598031584927377e+00,
                            6.09477967095006859e-02,
                            2.84347919290766749e-01,
                            -1.82269203727485132e-02,
                            -1.19301082530196320e-01,
                            1.05917358035740403e-02,
                            3.79147442314770669e-02,
                            3.81929247517211949e-04,
                            -3.66643962427926420e-02]
