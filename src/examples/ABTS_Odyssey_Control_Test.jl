...
args = Dict(# Misc Simulation
            ...
            :directory_results => "/workspaces/SpaceAGORA.jl_deprecated/journal_output/Mars_targ_pert_mc",                                  # Directory where to save the results
            ...
            :ra_fin_orbit => 9755e3, # 4840e3, # 9650e3, # 9730e3,                                # Target final apoapsis for the orbit, m
...
t = @elapsed begin
    ...
    # Run the simulation
    for i in collect(range(1,189,step=1))
