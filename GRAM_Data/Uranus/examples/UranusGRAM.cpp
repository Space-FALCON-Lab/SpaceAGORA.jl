...
{
  cout << "==========" << endl;
  string version = UranusAtmosphere::getVersionString();
  cout << version << endl;
  cout << "==========\n" << endl;
  ...
  try {
    ...
    if (!inputParameters.findDates) {
      ...
      trajProfile.setAtmosphere(uranus);
      ...
      uranus.findDates(inputParameters.targetLongitudeSun, inputParameters.targetSolarTime, gramTime, lonSun, tlst);
