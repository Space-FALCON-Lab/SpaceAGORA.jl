...
- ref_input.txt: Reference namelist inputs for VenusGRAM.
     + ref_LIST.md: List style output produced from ref_input.txt.
     + ref_OUTPUT.csv: CSV style output produced from ref_input.txt.
- traj_input.txt: Reference namelist inputs for VenusGRAM with trajectory inputs.
...
- find_dates.txt: Sample namelist inputs for finding LS/LTST dates using VenusGRAM.
