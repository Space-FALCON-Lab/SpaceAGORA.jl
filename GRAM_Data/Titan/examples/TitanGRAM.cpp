...
{
  cout << "===========" << endl;
  string version = TitanAtmosphere::getVersionString();
  cout << version << endl;
  cout << "===========\n" << endl;
  ...
  try {
    ...
    if (!inputParameters.findDates) {
      ...
      trajProfile.setAtmosphere(titan);
...
//      ProfilePrinter printer;
      ...
      titan.findDates(inputParameters.targetLongitudeSun, inputParameters.targetSolarTime, gramTime, lonSun, tlst);
