...
args = Dict(# Misc Simulation
            ...
            :directory_results => "/workspaces/SpaceAGORA.jl/output/basilisk_srp_comparison",                # Directory where to save the results
            ...
            :save_csv => true,                                     # Save facet forces to csv file
            # Type of Mission
