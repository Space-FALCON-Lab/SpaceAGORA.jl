...
helper_counts = 249 #vcat(1:1:49) #vcat(150:50:300) #vcat(50:50:100) # vcat(50:50:300) #vcat(150:50:300) #vcat(1, 50:50:300) # vcat(50:50:200)
target_altitudes_km = 1000.0 #[850.0, 950.0, 1000.0, 1050.0, 1150.0]# 850 # [950.0, 1000.0, 1050.0, 1150.0] # [850.0, 950.0, 1000.0, 1050.0, 1150.0] # [800]
target_inclinations_deg = [0.0, 0.5, 1.0] #[0.0, 0.5, 1.0, 1.5] #[0.0, 0.5, 1.0, 1.5]
...
for alt_km in target_altitudes_km
    for inc_deg in target_inclinations_deg
        ...
        println(@sprintf("\n>> Case h=%.0f km, i=%.1f deg total runtime: %.2f s (%.2f min)",
                         alt_km, inc_deg, case_elapsed, case_elapsed/60))
    end
end