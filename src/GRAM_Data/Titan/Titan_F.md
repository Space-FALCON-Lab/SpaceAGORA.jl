The TitanGRAM F Interface
===========================

This documents the FORTRAN interface for TitanGRAM.  Since the GRAM framework is common to all models, only the Titan specific information is documented on this page.  See the [FORTRAN interface](Documentation/Markdown/GRAM_F.md) page for documentation on the common framework.

A simple example of using the Titan atmosphere can be seen [here](@ref Titan/examples/Titan_F.f90).
...
~~~~~~~~~~
call setModelType_T(titan, 2); ! GCM95
...
~~~~~~~~~~
call setMinMaxFactor_T(titan, -0.2d0, 1)
~~~~~~~~~~
...
~~~~~~~~~~
call setMethaneMoleFraction_T(titan, 2.1d0);
~~~~~~~~~~
