...
# Run:  julia --project=. II_examples/oracle_laser_links.jl [options]
...
Base.@kwdef struct OracleLaserOptions
    ...
    output_dir::String         = joinpath(REPO_ROOT, "III_output", "oracle_laser_links")
    timeseries_points::Int     = 1001
end

function _usage()
    return """
    Usage: julia --project=. II_examples/oracle_laser_links.jl [options]
