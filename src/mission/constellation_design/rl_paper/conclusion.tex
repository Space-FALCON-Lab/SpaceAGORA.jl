...
\begin{enumerate}
    \item A DeepSet-based RL policy that handles variable-sized sets via permutation-invariant embeddings for satellites and debris clients.
...
The RL approach achieves computational efficiency by learning a policy that directly maps constellation state to satellite placement, avoiding expensive candidate evaluation. The permutation-invariant architecture enables generalization to different debris cluster sizes and compositions.
