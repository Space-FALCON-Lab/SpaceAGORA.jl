...
# ── Layout Knobs ──────────────────────────────────────────────────────────────
fig_size            = (950,950) #(800, 950)   # (width_px, height_px) — overall figure size
...
p1 = plot(legend=false, grid=true, tick_direction=:out,
          xlabel="Number of orbits (target satellite)", ylabel="P  [×10⁶ kg⋅m/s]",
...
_draw_panel!(p1, x_axis, all_ΔP, mean_ΔP, std_ΔP; scale=1e-6)
_yl = ylims(p1)
...
p2 = plot(legend=false, grid=true, tick_direction=:out,
          xlabel="Number of orbits (target satellite)", ylabel="H  [×10¹⁵ kg⋅m²/s]",
          xguidefontsize=xlabel_fontsize, yguidefontsize=ylabel_fontsize,
          yformatter=:plain,
          title="Total Angular Momentum",
          titlefontsize=title_fontsize,
          top_margin=panel_top_margin_mm*Plots.mm)
_draw_panel!(p2, x_axis, all_ΔH, mean_ΔH, std_ΔH; scale=1e-15)
_yl2 = ylims(p2)
...
p3 = plot(legend=false, grid=true, tick_direction=:out,
          xlabel="Number of orbits (target satellite)", ylabel="E  [×10¹¹ J]",
          xguidefontsize=xlabel_fontsize, yguidefontsize=ylabel_fontsize,
          yformatter=:plain,
          title="Total Orbital Energy",
          titlefontsize=title_fontsize,
          top_margin=panel_top_margin_mm*Plots.mm)
_draw_panel!(p3, x_axis, all_ΔE, mean_ΔE, std_ΔE; scale=1e-11)
_yl3 = ylims(p3)
