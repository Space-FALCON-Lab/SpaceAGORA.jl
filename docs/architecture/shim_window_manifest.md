...
## Enforcement
1. `test/gates/ci_architecture_contract_gate.jl` fails if retired wrappers reappear.
2. `test/gates/ci_benchmark_wrapper_parity_gate.jl` fails if retired wrappers reappear.
