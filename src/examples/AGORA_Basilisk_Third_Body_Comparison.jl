...
dynamic_effectors = (
    ...
    GravitationalHarmonicsModel(2, 0, joinpath(REPO_ROOT, "data/Gravity_harmonics_data", "GMM3.csv"), planet),
    # AerodynamicCoefficientfM(),
    # NBodyGravityModel(body_ids=(10,4,301,5), primary_body_id=planet.spice_id),
)
...
base_args = make_example_config(
    ...
    # orbits=4,
    initial_time=InitialTime(year=2012, month=5, day=1, hour=00, minute=28, second=30.0),
