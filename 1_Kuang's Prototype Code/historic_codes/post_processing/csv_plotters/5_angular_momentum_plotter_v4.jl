...
plt2 = scatter(title="Angular Momentum Fractional Drift ($dir_tag)", xlabel="t (s)",
...
for csv_path in csv_files
    ...
    scatter!(plt1, t_uniform, Hmag_u, label="N=$N", ms=3, markerstrokewidth=0)
    scatter!(plt2, t_uniform, ΔH_u,   label="N=$N", ms=3, markerstrokewidth=0)
end
