...
{
  cout << "=========" << endl;
  string version = VenusAtmosphere::getVersionString();
  cout << version << endl;
  cout << "=========\n" << endl;
  ...
  try {
    ...
    if (!inputParameters.findDates) {
      ...
      trajProfile.setAtmosphere(venus);
      ...
      venus.findDates(inputParameters.targetLongitudeSun, inputParameters.targetSolarTime, gramTime, lonSun, tlst);
