...
csv_path = normpath(joinpath(@__DIR__, "..", "output", "CSV",
    ...
    "timeseries_N2_T540000s_h1000km_t1000km_ih0.0deg_it0.0deg_B100_Pin1e+04_rmin0m_rmax2e+06_J2T.csv"))
...
plts = report_and_plot_OE_diff(sol, p[:mu];
                                sat1=1, sat2=2,
                                IMG_DIR=output_dir,
                                fn_prefix="OE_diff_sat1_sat2_large_range")
...
println("Saved OE diff plots to: $output_dir/OE_diff_sat1_sat2_large_range/")
