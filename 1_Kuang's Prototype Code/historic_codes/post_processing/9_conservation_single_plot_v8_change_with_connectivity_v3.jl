...
if orbit_common[end] >= 1.0
    ...
    plot!(p1, [_xl1[1], 1.0], [_v1, _v1], color=:gray,  linestyle=:dash, lw=0.8, label="")
    scatter!(p1, [1.0], [_v1], markersize=5, color=:black, markerstrokewidth=0.5,
             markerstrokecolor=:black, label="")
    annotate!(p1, _xl1[1], _v1,
              Plots.text(_fmt(_v1) * " ", Plots.default(:tickfontsize), :right, :vcenter, :black))
...
if orbit_common[end] >= 1.0
    ...
    plot!(p2, [_xl2[1], 1.0], [_v1, _v1], color=:gray,  linestyle=:dash, lw=0.8, label="")
    scatter!(p2, [1.0], [_v1], markersize=5, color=:black, markerstrokewidth=0.5,
             markerstrokecolor=:black, label="")
    annotate!(p2, _xl2[1], _v1,
              Plots.text(_fmt(_v1) * " ", Plots.default(:tickfontsize), :right, :vcenter, :black))
...
if orbit_common[end] >= 1.0
    ...
    plot!(p3, [_xl3[1], 1.0], [_v1, _v1], color=:gray,  linestyle=:dash, lw=0.8, label="")
    scatter!(p3, [1.0], [_v1], markersize=5, color=:black, markerstrokewidth=0.5,
             markerstrokecolor=:black, label="")
    annotate!(p3, _xl3[1], _v1,
              Plots.text(_fmt(_v1) * " ", Plots.default(:tickfontsize), :right, :vcenter, :black))
