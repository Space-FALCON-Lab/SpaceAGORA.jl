...
args = Dict(# Misc Simulation
            ...
            :directory_results => "output/cygnss_comparison_48hr_position",                # Directory where to save the results
            ...
            :mission_time => 48*60.0*60.0,                                  # Mission time in seconds, used only for Time mission type
            ...
            :L => 100,                                              # Maximum degree of the gravity harmonics (Defined in the file)
            :M => 100,                                              # Maximum order of the gravity harmonics (Defined in the file)
            ...
            # :a_initial_a => 6815502.867059532,                # Initial Semi-major axis for for-loop in m, slew
            :a_initial_a => 6818860.980734478, # 48hr
            # :a_initial_a => 6818.944e3,
            ...
            # :e_initial_a => 0.0011730915852158927, # slew
            :e_initial_a => 0.000509001111759744, # 48hr
            # :e_initial_a => 0.01,
            ...
            # :inclination => 35.00661348766785,  # slew                                 # Inclination Orbit, deg, slew
            :inclination => 34.93352843727813, # 48hr
            # :ω => 175.2543966534996, # slew                                             # AOP, deg, starting from 0s
            :ω => 140.63444072373724, # 48hr
            # :ω => 140.5323039642012,
            # :Ω => 143.5191343298872, # slew                                             # RAAN, deg, starting from 0s
            :Ω => 177.28777124177583, # 48hr
            # :ν => 345.8761488422457,   # slew                                            # True Anomaly, deg, starting from 0s
            :ν => 276.6524906717529,# 48hr
            ...
            # Final Conditions
            :final_apoapsis => 0.0, # 5088116.837416616, # 4905.974818462152e3                  # Final apoapsis radius if aerobraking campaign
