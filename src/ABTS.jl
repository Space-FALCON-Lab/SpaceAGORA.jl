...
args = Dict(# Misc Simulation
            ...
            :directory_results => "/home/space-falcon-1/Documents/ABTS.jl/output",            # Directory where to save the results
            ...
            :planettime => 452200000.0,                                     # Initial time of the mission, sec. Important for J2 effect and rotation of the planet
            ...
            :width_sat => 2.9,                                      # Width of the satellite in m
