...
data = CSV.read("/workspaces/SpaceAGORA.jl/data/Topography_harmonics_data/MOLA.csv", DataFrame)
data_true = CSV.read("/workspaces/SpaceAGORA.jl/data/Topography_harmonics_data/topogrd.csv", DataFrame, header=false)
