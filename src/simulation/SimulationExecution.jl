...
function execute_case(args::SimulationConfiguration, filename::String, temp_name::String; isolate_state::Bool=true)
    ...
    # while continue_campaign && FinalState
        ...
        t_el_ab = @elapsed begin
            ...
            # continue_campaign = execute_elements_case(initial_state, numberofpassage, args, params)
