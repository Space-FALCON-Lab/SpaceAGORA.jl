...
filter_B         = nothing   # e.g. 100.0
filter_Pin       = nothing   # e.g. 1e4
filter_min_range = nothing   # set both or neither
filter_max_range = nothing
filter_J2        = nothing  # true = only _J2T files, false = only _J2F files, nothing = all
title_fontsize   = 10
...
panel_heights = [1/3, 1/3, 1/3]  # relative heights for the three panels
fig_size = (800, 600)      # figure size in pixels
# ─────────────────────────────────────────────────────────────────────────────
