...
def load_settings() -> Settings:
    ...
    default_spice = _first_existing_path(repo_root / "data/GRAMSuite.jl/GRAM Suite 2.0" / "SPICE", repo_root / "GRAM_Data" / "SPICE")
    default_gram_data = _first_existing_path(repo_root / "data/GRAMSuite.jl/GRAM Suite 2.0", repo_root / "GRAM_Data")
    default_gram_root = _first_existing_path(repo_root / "data/GRAMSuite.jl/GRAM Suite 2.0", repo_root / "GRAMpy")
