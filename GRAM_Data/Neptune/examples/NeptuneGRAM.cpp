...
{
  cout << "======================" << endl;
  string version = NeptuneAtmosphere::getVersionString();
  cout << version << endl;
  cout << "======================\n" << endl;
  ...
  try {
    ...
    if (!inputParameters.findDates) {
      ...
      trajProfile.setAtmosphere(neptune);
      ...
      neptune.findDates(inputParameters.targetLongitudeSun, inputParameters.targetSolarTime, gramTime, lonSun, tlst);
