...
{
  cout << "===========" << endl;
  string version = JupiterAtmosphere::getVersionString();
  cout << version << endl;
  cout << "===========\n" << endl;
  ...
  try {
    ...
    if (!inputParameters.findDates) {
      ...
      trajProfile.setAtmosphere(jupiter);
      ...
      jupiter.findDates(inputParameters.targetLongitudeSun, inputParameters.targetSolarTime, gramTime, lonSun, tlst);
