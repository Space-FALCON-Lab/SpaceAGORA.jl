...
const VIEWER_MODULES = ("data.js", "colormaps.js", "globe.js", "atmosphere.js", "spacecraft.js", "lod.js", "ensemble.js", "paths.js", "references.js", "video.js", "plots.js", "terrain.js", "timeline.js", "lighting.js", "ui.js", "main.js")
const VIEWER_VENDOR = (
...
function build_viewer_frames(
    ...
    bytes_per_frame = S * ((pos_f64 ? 24 : 12) + (has_vel ? 12 : 0) + (has_q ? 16 : 0) + (has_mass ? 4 : 0) +
                           (has_density ? 4 : 0) + (has_heat ? 4 : 0) + (has_drag ? 4 : 0) + (has_wind ? 12 : 0)) + (has_sun ? 12 : 0) + 4 * lp_total + 4 * arm_total + 8
