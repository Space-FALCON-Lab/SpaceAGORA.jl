...
args = Dict(# Misc Simulation
            ...
            :directory_results => "/workspaces/ABTS.jl/output/Vex_heatload_control_in_loop_num_int",            # Directory where to save the results
            ...
            :hp_initial_a => 186.6e3,#176590.0,#188140.0           # Initial Periapsis Altitude for for-loop in m
