...
for csv_path in csv_files
    ...
    # 100 points evenly spaced in time via linear interpolation
    ...
    scatter!(plt1, t_uniform, Pmag_u, label="N=$N", ms=3, markerstrokewidth=0)
    scatter!(plt2, t_uniform, ΔP_u,   label="N=$N", ms=3, markerstrokewidth=0)
end
