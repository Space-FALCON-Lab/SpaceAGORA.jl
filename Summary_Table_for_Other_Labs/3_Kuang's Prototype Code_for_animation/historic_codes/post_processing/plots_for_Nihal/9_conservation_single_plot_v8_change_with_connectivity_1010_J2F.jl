...
annot_dx_p1 =  0.01;  annot_dy_p1 =  0.04   # ΔP panel label offset (fraction of axis range)
annot_dx_p2 =  0.01;  annot_dy_p2 =  0.04   # ΔH panel label offset
annot_dx_p3 =  -0.07;  annot_dy_p3 =  0.05   # Δε panel label offset
...
println("CSV directory : ", data_dir)
for f in csv_files
