...
{
  cout << "===========" << endl;
  string version = EarthAtmosphere::getVersionString();
  cout << version << endl;
  cout << "===========\n" << endl;
  ...
  try {
    ...
    if (!inputParameters.findDates) {
      ...
      MonteCarlo monte;
      monte.setSeedParameters(1, 16777216);
      ...
      if (inputParameters.useLegacyOutputs) {
        ...
        printer.setStyle(printer.GRAM_COLUMN_STYLE | printer.GRAM_LIST_STYLE | printer.EARTH_SPECIES_STYLE | printer.EARTH_BLTEST_STYLE);
      }
      ...
      earth.findDates(inputParameters.targetLongitudeSun, inputParameters.targetSolarTime, gramTime, lonSun, tlst);
