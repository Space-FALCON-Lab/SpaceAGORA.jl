...
args = Dict(# Misc Simulation
            ...
            :directory_results => "output/gmat_moon_comp",                # Directory where to save the results
            ...
            :mission_time => 16052.133608275,                                  # Mission time in seconds, used only for Time mission type
            ...
            # Physical Model
            :planet => 4,                                           # Earth = 0, Mars = 1, Venus = 2
            ...
            :a_initial_a => 2000.0*1e3, # starting from 900s
            # :a_initial_a => 6179921.801554798,
            # :a_initial_a => 10000.0e3,
            :a_initial_b => 2001.0e3,                               # Final Semi-major axis for for-loop in m
            ...
            :inclination => 30.0, # Starting from 900s
            ...
            :dt_max_orbit => 120.0,                                   # Maximum time step for orbit integration (outside atmosphere, i.e., step 1 and step 3), s
