...
args = Dict(# Misc Simulation
            ...
            :directory_results => "output/gmat_two_body_comp",                # Directory where to save the results
            ...
            :mission_time => 17485.549919638,                                  # Mission time in seconds, used only for Time mission type
            ...
            :a_initial_a => 7000.0*1e3, # starting from 900s
            # :a_initial_a => 6179921.801554798,
            # :a_initial_a => 10000.0e3,
            :a_initial_b => 7001.0e3,                               # Final Semi-major axis for for-loop in m
