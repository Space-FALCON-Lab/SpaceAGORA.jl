...
To build JupiterGRAM using a Linux/MinGW makefile, navigate to the folder /GRAM/Builds and follow the README instructions.

To build JupiterGRAM using MSVC++ 2017 or 2015, follow the instructions in the README file in \GRAM\MSVS.
